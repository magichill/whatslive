 ...
 */
@Component
public class BaiduAndroidPassThroughService extends BaiduBaseService {


    private static final Logger logger = getLogger(BaiduAndroidPassThroughService.class);

    /**
     *消息超时时间，目前设置为7天
     */
    private int msgExpires = 7*24*60*60;
     ...
     * @param messge 消息对象
     */
    public PushDetail pushMessageToSingleDevice(Long pushId, String channelId, PassThroughMessage messge) {
     ...
     * @param messge 消息对象
     */
    public PushDetail pushMessageToBatchDevice(Long pushId, String[] channelIds, PassThroughMessage messge){
        PushDetail result = PushDetail.getAndroidPushDetail(pushId);
     ...
     * @param messge 消息对象
     */
    public void pushMessageToAllDevice(long sendTime, PassThroughMessage messge){
        try {
            // 4. specify request arguments
...
//                throw e;
     ...
     * @param messge 消息对象
     */
    public void pushMessageToTag(String tag, long sendTime, PassThroughMessage messge){
        try {
            // 4. specify request arguments
            // pushTagTpye = 1 for common tag pushing
