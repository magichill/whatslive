...
<head>
    ...
    <script type="text/javascript">
        jQuery(function () {
            ...
            require(['pagejs/comment/virtualComment'], function (VirtualComment) {
                var virtualComment = new VirtualComment({
                    host: "${ctx}"
                });
                virtualComment.show();
            });
...
<div class="container-fluid">
    ...
    <div id="contentList" class="row-fluid">
        ...
        <!-- BEGIN TABLE virtualComment-->
        <div id="content_virtualComment_list" data-sign="content" class="span12">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-reorder"></i>预加载评论管理</div>
                </div>
                <div class="portlet-body">
                    <div id="form_virtualComment_search" class="form-inline">
                        <input type="text" name="search_content" class="span2" placeholder="评论内容">
                        <select name="search_status" class="span2 m-wrap">
                            <option value="">所有评论</option>
                            <option value="1">启用</option>
                            <option value="0">停用</option>
                        </select>
                        <button id="btn_virtualComment_search" type="button" class="btn blue">搜索<i class="icon-search"></i>

                        </button>
                        <button id="btn_virtualComment_new" class="btn green">
                            新增评论 <i class="icon-plus"></i>
                        </button>
                        <%--<button id="btn_virtualComment_addBatch" class="btn blue">
                            批量导入虚拟评论<i class="icon-plus"></i>--%>
                        </button>
                    </div>
                    <table id="table_virtualComment_list" class="table table-striped table-bordered table-hover">
                        <thead>
                        </thead>
                        <tbody>
                        </tbody>
        ...
        <!-- END TABLE virtualComment-->

        <!-- BEGIN UPDATE/ADD virtualComment -->
        <div id="content_virtualComment_edit" data-sign="content" class="span12" style="margin-left: 0px;">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-list-alt"></i>评论信息</div>
                </div>
                <div id="div_virtualComment_edit" class="portlet-body form">
                </div>
            </div>
            <!-- END UPDATE/ADD virtualComment-->
        </div>
