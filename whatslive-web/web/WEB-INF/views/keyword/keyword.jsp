...
<head>
    ...
    <script type="text/javascript">
        jQuery(function () {
            ...
            require(['pagejs/keyword/keyword'], function (Keyword) {
...
<div class="container-fluid">
    ...
    <div id="contentList" class="row-fluid">
        ...
        <!-- BEGIN TABLE keyword-->
        <div id="content_keyword_list" data-sign="content" class="span12">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-reorder"></i>关键词管理</div>
                </div>
                <div class="portlet-body">
                    <div id="form_keyword_search" class="form-inline">
                        <input type="text" name="search_key" class="span2" placeholder="关键词">
                        <select name="search_status" class="span2 m-wrap">
                            <option value="">所有关键词</option>
                            <option value="1">启用</option>
                            <option value="0">停用</option>
                        </select>
                        <button id="btn_keyword_search" type="button" class="btn blue">搜索<i class="icon-search"></i>

                        </button>
                        <button id="btn_keyword_new" class="btn green">
                            新增关键词 <i class="icon-plus"></i>
                        </button>
                    </div>
                    <table id="table_keyword_list" class="table table-striped table-bordered table-hover">
                        <thead>
                        </thead>
                        <tbody>
                        </tbody>
        ...
        <!-- BEGIN UPDATE/ADD keyword -->
        <div id="content_keyword_edit" data-sign="content" class="span12" style="margin-left: 0px;">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-list-alt"></i>关键词信息</div>
                </div>
                <div id="div_keyword_edit" class="portlet-body form">
                </div>
            </div>
            <!-- END UPDATE/ADD keyword-->
        </div>
