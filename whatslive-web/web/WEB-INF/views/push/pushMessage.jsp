...
<head>
    ...
    <script type="text/javascript">
        jQuery(function () {
            ...
            require(['pagejs/push/pushMessage'], function (PushMessage) {
...
<div class="container-fluid">
    ...
    <div id="contentList" class="row-fluid">
        ...
        <!-- BEGIN TABLE pushMessage-->
        <div id="content_pushMessage_list" data-sign="content" class="span12">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-reorder"></i>推送消息管理</div>
                </div>
                <div class="portlet-body">
                    <div id="form_pushMessage_search" class="form-inline">
                        <input type="text" name="search_content" class="span2" placeholder="消息内容">
                        <select name="search_status" class="span2 m-wrap">
                            <option value="">所有状态</option>
                            <option value="2">发送成功</option>
                            <option value="0,1,3">未成功</option>
                        </select>
                        <button id="btn_pushMessage_search" type="button" class="btn blue">搜索<i class="icon-search"></i>

                        </button>
                        <button id="btn_pushMessage_new" class="btn green">
                            新增推送 <i class="icon-plus"></i>
                        </button>
                    </div>
                    <table id="table_pushMessage_list" class="table table-striped table-bordered table-hover">
                        <thead>
                        </thead>
                        <tbody>
                        </tbody>
        ...
        <!-- END TABLE pushMessage-->

        <!-- BEGIN UPDATE/ADD pushMessage -->
        <div id="content_pushMessage_edit" data-sign="content" class="span12" style="margin-left: 0px;">
            <div class="portlet box blue">
                <div class="portlet-title">
                    <div class="caption"><i class="icon-list-alt"></i>推送消息</div>
                </div>
                <div id="div_pushMessage_edit" class="portlet-body form">
                </div>
            </div>
            <!-- END UPDATE/ADD pushMessage-->
        </div>
