...
<head>
  ...
  <script type="text/javascript">
    jQuery(function () {
      ...
      require(['pagejs/video/order'], function (Order) {
        var order = new Order({
          host: "${ctx}"
        });
        order.show();
    ...
    <div id="content_user_list" data-sign="content" class="span12">
      <div class="portlet box blue">
            <div class="portlet-title">
              <div class="caption"><i class="icon-reorder"></i>预约</div>
            </div>
            <div class="portlet-body">
              ...
              <div id="form_video_search" class="form-inline">
                ...
                <button id="btn_video_search_pType" type="button" class="btn blue">搜索<i class="icon-search"></i>
                </button>
              </div>
