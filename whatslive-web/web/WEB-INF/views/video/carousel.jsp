...
<head>
  ...
  <script type="text/javascript">
    jQuery(function () {
      ...
      require(['pagejs/video/carousel'], function (Carousel) {
...
<div class="container-fluid">
  ...
  <div id="contentList" class="row-fluid">
    ...
    <div id="content_live_list" data-sign="content" class="span12">
      <div class="portlet box blue">
            <div class="portlet-title">
              <div class="caption"><i class="icon-reorder"></i>轮播管理</div>
            </div>
            <div class="portlet-body">
              <div id="form_live_search" class="form-inline">
                <button id="btn_video_new" class="btn green">
                  新增轮播 <i class="icon-plus"></i>
                </button>
              </div>
    ...
    <div id="content_video_cover_edit" data-sign="content" class="span12" style="margin-left: 0px;">
      <div class="portlet box blue">
        <div class="portlet-title">
          <div class="caption"><i class="icon-list-alt"></i>修改轮播</div>
        </div>
