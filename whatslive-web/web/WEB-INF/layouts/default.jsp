...
<head>
    ...
    <link href="${ctx }/static/lib/select2/select2.css" rel="stylesheet" type="text/css"/>
    <link href="${ctx }/static/lib/select2/select2_metro.css" rel="stylesheet" type="text/css"/>
    ...
    <script src="${ctx}/static/lib/select2/select2.js" type="text/javascript"></script>
    <!-- END CORE PLUGINS -->
    <!-- END JAVASCRIPTS -->
    <sitemesh:head/>
</head>
