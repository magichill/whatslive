...
var App = function () {
    ...
    var handleUnderscoreTemplateSettings = function () {
    ...
    return {
        STATUS_UNDEFINED: 999,
        STATUS_INVALID: 0,
        STATUS_VALID: 1,
        STATUS_AUDIT_NEED: 11,
        STATUS_AUDIT_YES: 12,
        STATUS_AUDIT_NO: 13,
        STATUS_LINE_NEED: 21,
        STATUS_LINE_ON: 22,
        ...
        init: function (hostObj) {

            this.ctx = "";
            this.fileHost = "";
            if (hostObj !== undefined && typeof hostObj === "object") {
                this.ctx = hostObj.ctx || "";
                this.fileHost = hostObj.fileHost || "";
            }
            //IMPORTANT!!!: Do not modify the dao handlers call order.
            ...
            //underscore handlers
            handleUnderscoreTemplateSettings();//handle underscore temp settings
