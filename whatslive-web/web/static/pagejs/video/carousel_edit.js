define(function () {
    ...
    function CarouselEdit(options) {
        this.init(options);
    }

    CarouselEdit.prototype = {
        ...
        loadContent: function () {
            var that = this;
            var url = this.options.host + "/carousel/page/editCarousel";
        ...
        initValidate: function () {
            this.validate = $("#form_video").validate({
                onsubmit: false,
                errorElement: "span",
        ...
        initEvents: function () {
            var that = this;
            //查询组件
            $("#userId").select2({width: "200", allowClear: true}).prop("disabled", true);
            var pid = $("#id").val();
        ...
        btnSave: function () {
            ...
            // 保存请求
            $.ajax({
                url: that.options.host + "/carousel/saveCarousel",
                type: "post",
