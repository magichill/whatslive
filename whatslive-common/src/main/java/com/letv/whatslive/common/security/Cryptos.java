 ...
 *******************************************************************************/
package com.letv.whatslive.common.security;

import com.letv.whatslive.common.utils.Exceptions;
...
//    private static final String secretKey = "abcdefghijklmnopqrstuvwxyz";
    private static final String secretKey = PropertiesGetter.getValue("cryptos.key");
    ...
    public static String encrypt(String plainText) {
        String encryption = "";
        try {
            plainText = new String(plainText.getBytes("iso-8859-1"), "iso-8859-1");
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public static String decrypt(String encryption) {
        ...
        String decoding = "";
        try {
            decoding = new String(String.valueOf(decryption).getBytes("iso-8859-1"), "iso-8859-1");
        } catch (Exception e) {
            e.printStackTrace();
        }
        return decoding;
