...
public class ForbiddenWordUtils {
     ...
     * 屏蔽关键词抓取时间间隔 毫秒
     */
    private static int reloadInterval = 600000; //10分钟

    /**
     * 屏蔽关键词
     */
    private static CopyOnWriteArrayList<Pattern> forbiddenWords;
...
//    }
    ...
    public static CopyOnWriteArrayList<Pattern> getForbiddenWords() {
    ...
    private static void loadForbiddenWords(byte[] fileCBytes) throws IOException {
        ...
        try {
            ...
            if(forbiddenWords != null)
            {
                ...
                forbiddenWords = Lists.newCopyOnWriteArrayList();
            }
