 ...
 */
@Repository
public class MediaMongoTemplate {


    private static final Logger logger = LoggerFactory.getLogger(MongoTemplate.class);

    @Value("${media.mongo.replica.set}")
    protected String host;

    @Value("${media.mongo.database}")
    protected String db;

    @Value("${media.mongo.auth}")
    protected String auth;

    @Value("${media.mongo.connections}")
    protected String connections;

    @Value("${media.mongo.password}")
    protected String password;

    @Value("${media.mongo.user}")
