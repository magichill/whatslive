package com.letv.whatslive.website.controller.mobile;
...
import com.letv.whatslive.website.service.weixin.WeixinSignService;
...
public class mobileController extends PubController {
     ...
     * @return
     */
    @RequestMapping("/mobileLive")
    public ModelAndView mobileLiveInit(WebRequest webRequest, HttpServletRequest request) throws Exception {
        ...
        try {
            ...
            // debugflg
//            String debugFlg = webRequest.getParameter("debug");
//            if ("true".equals(debugFlg)) {
//
//                videoInfo.setDebugFlg("true");
//            }
            ...
            try {
                ...
                if (program != null) {
                    ...
                    if (liveId != null && !"".equals(liveId)) {
                        ...
                        // 选定的视频为轮播台视频时, 显示首页
                        modelAndView = new ModelAndView("redirect:/mobile");
                        return modelAndView;
                    }
                } else {
            ...
            // 获取微信用签名信息
            Map<String, String> weixinInfoMap = weixinSignService.getSignature(url.replace("//mobile","/mobile"));
            // 微信公众号的唯一标识
            videoInfo.setAppid(PropertyGetter.getString("appid"));
            // 生成签名的时间戳
            videoInfo.setSignTimestamp(weixinInfoMap.get("timestamp"));
            // 生成签名的随机串
            videoInfo.setSignNonceStr(weixinInfoMap.get("nonceStr"));
            // 签名
            videoInfo.setSignature(weixinInfoMap.get("signature"));
            ...
            if((ProgramConstants.pType_live.equals(videoInfo.getProgramType()))
                ...
                modelAndView.setViewName("/mobile/mobileLive");
                ...
                modelAndView.setViewName("/mobile/mobileReplay");
                ...
                modelAndView.setViewName("/mobile/mobileOrder");
            }
        } catch (Exception e) {
     ...
     * @return
     */
    @RequestMapping("/mobileGetWatchedNum")
    @ResponseBody
